...
export const createHearingSchema = z.object({
  procedure_id: z.string({error : "hearings.fields.procedure.errors.required"}).min(1, "cases.fields.procedure.errors.required"),
  ...
  hearing_type : z.string().min(1, "hearings.fields.hearing_type.errors.required"),
