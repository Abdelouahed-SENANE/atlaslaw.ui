...
export const HearingForm = ({
  ...
  const [caseId, setCaseId] = React.useState<string | undefined>(undefined);
  ...
  const handleSubmit = React.useCallback(
    (values: HearingFormInputs) => {
      const payload = {
        ...
        procedure_id: values.procedure_id || undefined,
  ...
  return (
    <FormDrawer
      title={
        mode === "create"
          ? t("hearings.form.create")
          : t("hearings.form.update")
      }
              ...
              <div>
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => {
                    return (
                      <ProcedureSelector
                        placeholder={t("hearings.fields.procedure.placeholder")}
                        caseId={caseId}
                        error={
                          (fieldState.error?.message &&
                            t(fieldState.error?.message)) ||
